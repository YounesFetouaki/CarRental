                ...
                <div class="container ">
                    ...
                    <form action="{{url('/update_product', $data[0]->product_id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-2 w-30 m-auto">
                            ...
                            <input type="text" class="form-control" id="product_keywords" value="{{$data[0]->price}}" name="product_price" aria-describedby="product_price_help" placeholder="Enter product Price" autocomplete="on" required="required">
                        </div>

                        <!-- product_discount_price-->
                        <div class="form-outline mb-2 w-30 m-auto">
                            <label for="product_price" style="color: white;" class="form-label fw-bold">Product Discount Price</label>
                            <input type="text" class="form-control" id="product_keywords" value="{{$data[0]->discounted_price}}" name="product_discount_price" aria-describedby="product_price_help" placeholder="Enter product discount Price" autocomplete="on" required="required">
                        </div>

                        <!-- product_days-->
                        <div class="form-outline mb-2 w-30 m-auto">
                            <label for="product_price" style="color: white;" class="form-label fw-bold">Days </label>
                            <input type="text" class="form-control" value="{{$data[0]->days}}" id="product_keywords" name="product_days" aria-describedby="product_price_help" placeholder="Enter product Price" autocomplete="on" required="required">
                        </div>

                        <!-- product_ capacity-->
                        <div class="form-outline mb-2 w-30 m-auto">
                            <label for="product_capacity" style="color: white;" class="form-label fw-bold">Sitting Capacity</label>
                            <input type="text" class="form-control" id="product_capacity" name="product_capacity" placeholder="Enter car seat capacity" autocomplete="on" required="required" value="{{$data[0]->product_capacity}}">
                        </div>
                        <!-- product_ lisence -->
                        <div class="form-outline mb-2 w-30 m-auto">
                            <label for="product_lisence" style="color: white;" class="form-label fw-bold">Car lisence number</label>
                            <input type="text" class="form-control" id="product_lisence" name="product_lisence" placeholder="Enter car lisence number" autocomplete="on" required="required" value="{{$data[0]->product_lisence}}">
                        </div>
                        <!-- Image-->
                        <div class="form-outline mb-2 w-30 m-auto">
